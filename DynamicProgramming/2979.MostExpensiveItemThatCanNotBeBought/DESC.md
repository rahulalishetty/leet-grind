...
Alice and Bob are visiting a market. The market has an infinite number of items; for any positive integer `x`, there exists an item whose price is `x`. Alice wants to buy some items from the market to gift to Bob. She has an infinite number of coins in the denominations `primeOne` and `primeTwo`. She wants to know the most expensive item she cannot buy to gift to Bob.

Return the price of the most expensive item which Alice cannot gift to Bob.
