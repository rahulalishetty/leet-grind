...
- The size of each block of consecutive `1`s is a multiple of `oneGroup`.
  For example, in a binary string `00110111100`, sizes of each block of consecutive `1`s are `[2, 4]`.
- The size of each block of consecutive `0`s is a multiple of `zeroGroup`.
  For example, in a binary string `00110111100`, sizes of each block of consecutive `0`s are `[2, 1, 2]`.
