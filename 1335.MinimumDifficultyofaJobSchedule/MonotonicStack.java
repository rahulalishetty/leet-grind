class MonotonicStack {
  public int minDifficulty(int[] jobDifficulty, int d) {
    ...
    // min_diff_curr_day and min_diff_prev_day record the minimum total job
    // difficulty
    ...
    for (int day = 0; day < d; ++day) {
      ...
      for (int i = day; i < n; i++) {
        // We initialize min_diff_curr_day[i] as only performing 1 job at the i-th
        // index.
        ...
        // When we find the last element in the stack is smaller than or equal to
        // current job,
