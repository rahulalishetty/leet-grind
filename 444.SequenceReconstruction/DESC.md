...
- For `sequences = [[1,2],[1,3]]`, there are two shortest supersequences: `[1,2,3]` and `[1,3,2]`.
- For `sequences = [[1,2],[1,3],[1,2,3]]`, the only shortest supersequence possible is `[1,2,3]`. `[1,2,3,4]` is a possible supersequence but not the shortest.
...
- The sequence `[1,2]` is a subsequence of `[1,2,3]`.
- The sequence `[1,3]` is a subsequence of `[1,2,3]`.
