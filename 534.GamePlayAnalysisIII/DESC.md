...
Write a solution to report for each player and date, how many games were played so far by the player. That is, the total number of games played by the player until that date. Check the example for clarity.
...
- 5 + 6 = 11 games played by 2016-05-02
- 5 + 6 + 1 = 12 games played by 2017-06-25

For the player with id 3:

- 0 + 5 = 5 games played by 2018-07-03
